...
void atk_8266_get_ip(u8 x);
void atk_8266_msg_show(u16 x,u8 wanip);
void atk_8266_wificonf_show(u16 x,u8* rmd,u8* ssid,u8* encryption,u8* password);
u8 atk_8266_netpro_sel(u16 x,u8* name);
